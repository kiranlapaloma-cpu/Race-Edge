...
def build_metrics_and_shape(df_in: pd.DataFrame,
    ...
    if use_race_shape:
        ...
        # --- graduated mid-lull helper (1400m+) ---
        sci_gate_slow = 0.55
        if D >= 1400:
            ...
            lull_gap = late_med - mid_med
            if D >= 2000:      m1, m2, sci_gate_slow = 0.90, 0.85, 0.53
            elif D >= 1800:    m1, m2, sci_gate_slow = 0.92, 0.88, 0.535
            elif D >= 1600:    m1, m2, sci_gate_slow = 0.95, 0.92, 0.540
            else:              m1, m2, sci_gate_slow = 0.97, 0.94, 0.545
