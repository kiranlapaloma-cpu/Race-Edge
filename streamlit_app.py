...
# ---- Base by distance BAND ----
if dm <= 1200:
    base = {"F200_idx":0.08, "tsSPI":0.24, "Accel":0.40, "Grind":0.28}
    band = "SPRINT"
elif dm <= 2000:
    base = {"F200_idx":0.08, "tsSPI":0.36, "Accel":0.32, "Grind":0.24}
    band = "MIDDLE"
else:
    base = {"F200_idx":0.08, "tsSPI":0.46, "Accel":0.22, "Grind":0.24}
    band = "STAYER"
